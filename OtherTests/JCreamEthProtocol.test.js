...
describe('JProtocol', function () {
  ...
  it("user2 buys some token EthTrA", async function () {
    ...
    tx = await this.JCream.buyTrancheAToken(0, web3.utils.toWei("1", "ether"), {from: user2, value: web3.utils.toWei("1", "ether")});
  ...
  it("user3 buys some token EthTrA", async function () {
    ...
    tx = await this.JCream.buyTrancheAToken(0, web3.utils.toWei("1", "ether"), {from: user3, value: web3.utils.toWei("1", "ether")});
  ...
  it("user2 redeems token EthTrA", async function () {
    ...
    console.log("JCream cEth balance: "+ web3.utils.fromWei(await this.JCream.getTokenBalance(this.CEther.address), "ether") + " cEth");
    tx = await this.EthTrA.approve(this.JCream.address, bal, {from: user2});
    tx = await this.JCream.redeemTrancheAToken(0, bal, {from: user2});
  ...
  it("user3 redeems token EthTrA", async function () {
    ...
    console.log("JCream cEth balance: "+ web3.utils.fromWei(await this.JCream.getTokenBalance(this.CEther.address), "ether") + " cEth");
    tx = await this.EthTrA.approve(this.JCream.address, bal, {from: user3});
    tx = await this.JCream.redeemTrancheAToken(0, bal, {from: user3});
  ...
  it("user2 redeem tokens from EthTrB", async function () {
    ...
    console.log("JCream cEth balance: "+ web3.utils.fromWei(await this.JCream.getTokenBalance(this.CEther.address), "ether") + " cEth");
    console.log("TrB price: " + web3.utils.fromWei(await this.JCream.getTrancheBExchangeRate(0, 0), "ether"));
    tx = await this.EthTrB.approve(this.JCream.address, bal, {from: user2});
    tx = await this.JCream.redeemTrancheBToken(0, bal, {from: user2});
    newBal = web3.utils.fromWei(await web3.eth.getBalance(user2), "ether");
    console.log("User2 New Eth balance: "+ newBal + " ETH");
  ...
  it("user3 redeeem tokens from EthTrB", async function () {
    ...
    console.log("JCream cEth balance: "+ web3.utils.fromWei(await this.JCream.getTokenBalance(this.CEther.address), "ether") + " cEth");
    console.log("TrB price: " + web3.utils.fromWei(await this.JCream.getTrancheBExchangeRate(0, 0), "ether"));
    tx = await this.EthTrB.approve(this.JCream.address, bal, {from: user3});
    tx = await this.JCream.redeemTrancheBToken(0, bal, {from: user3});
    newBal = web3.utils.fromWei(await web3.eth.getBalance(user3), "ether");
    console.log("User3 New Eth balance: "+ newBal + " ETH");
